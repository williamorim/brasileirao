...
scraper_ge_2022 <- function(round) {
  round <- stringr::str_pad(round, 2, "left", "0")
  url <- glue::glue(
    "https://api.globoesporte.globo.com/tabela/d1a37fa4-e948-43a6-ba53-ab24ab3a45b1/fase/fase-unica-campeonato-brasileiro-2022/rodada/{round}/jogos/"
  )
  Sys.sleep(1)
  res <- httr::GET(url)
  tab <- res |>
...
scraper_ge_2024 <- function(round) {
  round <- stringr::str_pad(round, 2, "left", "0")
  url <- glue::glue(
...
scraper_ge_2025 <- function(round) {
  round <- stringr::str_pad(round, 2, "left", "0")
  url <- glue::glue(
    "https://api.globoesporte.globo.com/tabela/d1a37fa4-e948-43a6-ba53-ab24ab3a45b1/fase/fase-unica-campeonato-brasileiro-2025/rodada/{round}/jogos/"
  )
  Sys.sleep(1)
  res <- httr::GET(url)
  tab <- res |>
